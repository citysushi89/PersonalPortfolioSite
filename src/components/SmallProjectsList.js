...
const smallerProjectsList = [
    {
        ...
        description: "Program uses your choice of Morse Code or the Caesar Cipher to encode and decode text.",
    ...
    },
    {
        ...
        description: "The Program is a text-based Blackjack game.",
        tagOne: "Tag concepts / libraries / languages used",
        tagTwo: "ie Python",
        tagThree: "ie pyperclip",
    ...
    },
    {
        ...
        description: "Program takes a picture and a watermark as inputs and returns a watermarker image.",
        tagOne: "Tag concepts / libraries / languages used",
        tagTwo: "ie Python",
        tagThree: "ie pyperclip",
        gitURL: "",
